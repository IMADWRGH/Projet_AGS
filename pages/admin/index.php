        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">États des departements</h1>
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">États des comptes</h1>
                                ...
                                <div class="table-responsive">
                                    <ul class="list-group list-group-flush">
                                        <li class="list-group-item  d-flex justify-content-between align-items-center">
                                            ...
                                            <div class="col flex-fill p-0 font-weight-bold">État</div>
                                            <div class="col flex-fill p-0 font-weight-bold">Créé à</div>
                                        </li>
                                        <?php
